...
class BaseExecutor {
    ...
    _consume() {
        ...
        .then((msg) => {
            ...
            // TODO: sample once a bug in hot-shots resolved
            this.hyper.metrics.increment(`${this.statName}_dequeue`);
            ...
            const optionIndex = this.getOptionIndex(message);
            if (optionIndex !== -1) {
                ...
                this.processMessage(message, optionIndex)
                .finally(() => {
    ...
    _exec(origEvent, optionIndex, statDelayStartTime, retryEvent) {
